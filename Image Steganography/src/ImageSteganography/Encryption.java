...
public class Encryption extends JFrame implements ActionListener{
    JButton open = new JButton("Open"), embed = new JButton("Encode"),save = new JButton("Save into new file"), reset = new JButton("Reset");
    ...
    private void assembleInterface() {
        ...
        p.setBorder(BorderFactory.createTitledBorder("Message to be encoded"));
    ...
    private void saveImage() {
        if(embeddedImage == null) {
            JOptionPane.showMessageDialog(this, "No message has been encoded!", "Nothing to save", JOptionPane.ERROR_MESSAGE);
            return;
        }
